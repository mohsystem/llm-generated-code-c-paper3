...
int main() {
    ...
    printf("%d\n", calculateYears(500.00, 0.10, 0.20, 600.00)); // Expected: 2
    printf("%d\n", calculateYears(2000.00, 0.03, 0.15, 2200.00)); // Expected: 4
    printf("%d\n", calculateYears(1500.00, 0.07, 0.12, 1600.00)); // Expected: 2
    return 0;
}