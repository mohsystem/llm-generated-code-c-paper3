...
char* readOperation(Task112* task, const char* name) {
...
int main() {
    ...
    printf("\\nTest Case 2: readOperation a document\\n");
    printf("%s\\n", readOperation(mongoOps, "John Doe"));
    
    printf("\\nTest Case 3: Update a document\\n");
    printf("%s\\n", update(mongoOps, "John Doe", 31));
    
    printf("\\nTest Case 4: readOperation updated document\\n");
    printf("%s\\n", readOperation(mongoOps, "John Doe"));
