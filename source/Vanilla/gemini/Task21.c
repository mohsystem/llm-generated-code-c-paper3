...
int main() {
    ...
    for (int i = 0; i < newSize1; i++) printf("%d ", result1[i]);
    printf("\n"); // Output: 2 3 4 5
    free(result1);
    ...
    for (int i = 0; i < newSize2; i++) printf("%d ", result2[i]);
    printf("\n"); // Output: 5 3 2 4
    free(result2);
    ...
    for (int i = 0; i < newSize3; i++) printf("%d ", result3[i]);
    printf("\n"); // Output: 2 2 2 1
    free(result3);
    ...
    for (int i = 0; i < newSize4; i++) printf("%d ", result4[i]);
    printf("\n"); // Output:
    free(result4);
    ...
    for (int i = 0; i < newSize5; i++) printf("%d ", result5[i]);
    printf("\n"); // Output: 
    free(result5);
