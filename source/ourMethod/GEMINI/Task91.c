...
#define SSIZE_T int // Windows uses int for return of recvfrom
#else
#include <sys/socket.h>
#include <netinet/in.h>
#include <arpa/inet.h>
#include <unistd.h>
#include <sys/types.h> // POSIX standard header for types like ssize_t
#define SOCKET int
#define INVALID_SOCKET -1
#define closesocket close
#define SSIZE_T ssize_t // POSIX standard return type for recvfrom
#endif
