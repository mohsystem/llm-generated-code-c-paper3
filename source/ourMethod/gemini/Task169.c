...
int main() {
    ...
    for (int i = 0; i < returnSize1; i++) printf("%d ", result1[i]); // Output: 2 1 1 0
    printf("\n");
    free(result1);
    ...
    for (int i = 0; i < returnSize2; i++) printf("%d ", result2[i]); // Output: 0
    printf("\n");
    free(result2);
    ...
    for (int i = 0; i < returnSize3; i++) printf("%d ", result3[i]); // Output: 0 0
    printf("\n");
    free(result3);
    ...
    for (int i = 0; i < returnSize4; i++) printf("%d ", result4[i]); // Output: 0 0 0 0
    printf("\n");
    free(result4);
    ...
    for (int i = 0; i < returnSize5; i++) printf("%d ", result5[i]); // Output: 3 2 1 0
    printf("\n");
    free(result5);
